  ...
  pt: {
    translations: {
      ...
      transferTicketModal: {
        ...
        fieldQueuePlaceholder: "Selecione um fila",
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os atendimentos dessa fila continuarão existindo, mas não terão mais nenhum fila atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Filas",
