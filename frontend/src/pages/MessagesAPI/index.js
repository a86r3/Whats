  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensagens, é necessário o cadastro do token vinculado à conexão que enviará as mensagens. <br/>Para realizar o cadastro acesse o menu "WhatsApp", clique no botão editar da conexão e copie o token no devido campo.</li>
          <li>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"551199999999\", \"body\": \"Sua mensagem\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin}>
            <b>Demonstrativo de Envio</b>
          </Typography>
